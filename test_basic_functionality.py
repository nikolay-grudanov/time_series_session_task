...
def test_ticker_validation():
    ...
    for ticker in valid_tickers:
        ...
        if result.is_valid:
            ...
            print(
                f"✗ Valid ticker '{ticker}' incorrectly rejected: {result.error_message}"
            )
            all_passed = False
...
def test_investment_validation():
    ...
    for investment in valid_investments:
        ...
        if result.is_valid:
            ...
            print(
                f"✗ Valid investment ${investment} incorrectly rejected: {result.error_message}"
            )
            all_passed = False
    ...
    for investment in invalid_investments:
        ...
        if not result.is_valid:
            print(
                f"✓ Invalid investment {investment} correctly rejected: {result.error_message}"
            )
        else:
